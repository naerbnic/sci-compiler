...
struct OpStr {
  ...
  UInt16 info;
    ...
    "div",   JUST_OP,           "mod",      JUST_OP,
    "shr",   JUST_OP,           "shl",      JUST_OP,
    "xor",   JUST_OP,           "and",      JUST_OP,
    "or",    JUST_OP,

    "neg",   JUST_OP,           "not",      JUST_OP,

    "eq?",   JUST_OP,           "ne?",      JUST_OP,
    "gt?",   JUST_OP,           "ge?",      JUST_OP,
    "lt?",   JUST_OP,           "le?",      JUST_OP,

    "ugt?",  JUST_OP,           "uge?",     JUST_OP,
    "ult?",  JUST_OP,           "ule?",     JUST_OP,

    "bt",    OP_ARGS | OP_SIZE, "bnt",      OP_ARGS | OP_SIZE,
    "jmp",   OP_ARGS | OP_SIZE,

    "ldi",   OP_ARGS | OP_SIZE, "push",     JUST_OP,
    "pushi", OP_ARGS | OP_SIZE, "toss",     JUST_OP,
    "dup",   JUST_OP,           "link",     OP_ARGS | OP_SIZE,

    "call",  OP_ARGS | OP_SIZE, "callk",    OP_ARGS | OP_SIZE,
    "callb", OP_ARGS | OP_SIZE, "calle",    OP_ARGS | OP_SIZE,

    "ret",   JUST_OP,

    "send",  JUST_OP,           "DUMMY",    JUST_OP,
    "DUMMY", JUST_OP,

    "class", OP_ARGS | OP_SIZE, "DUMMY",    JUST_OP,
    "self",  JUST_OP,           "super",    OP_ARGS | OP_SIZE,
    "&rest", OP_ARGS | OP_SIZE,

    "lea",   OP_ARGS | OP_SIZE, "selfID",   JUST_OP,
    "DUMMY", JUST_OP,           "pprev",    JUST_OP,

    "pToa",  OP_ARGS | OP_SIZE, "aTop",     OP_ARGS | OP_SIZE,
    "pTos",  OP_ARGS | OP_SIZE, "sTop",     OP_ARGS | OP_SIZE,
    "ipToa", OP_ARGS | OP_SIZE, "dpToa",    OP_ARGS | OP_SIZE,
    "ipTos", OP_ARGS | OP_SIZE, "dpTos",    OP_ARGS | OP_SIZE,

    "lofsa", OP_ARGS | OP_SIZE, "lofss",    OP_ARGS | OP_SIZE,
    "push0", JUST_OP,           "push1",    JUST_OP,
    "push2", JUST_OP,           "pushSelf", JUST_OP,
};
